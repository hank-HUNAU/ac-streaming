...
def group_sections(raw_sections):
    ...
    major_patterns = [
        ...
        # Ch05 - Gastrointestinal Health
        r'^Major Polyphenols in Grapes',
        r'^Absorption and Metabolism',
        r'^Mutual Interactions',
        r'^Grape Products Promote',
        r'^The Impact of Polyphenols on Intestinal',
        r'^Effects of Polyphenols and Grapes on Intestinal Disorders',
        r'^Effects of Grape Polyphenols on Celiac',
        r'^The Effects of Grape Polyphenols on Irritable',
        r'^Preventive Effects of Grape',
        r'^The Role of Gut Microbiota',
        r'^Biological Properties of Grapes',
        # Ch06 - Skin Health
        r'^Importance of Skin Health',
        r'^Role of Oxidative Stress in the Skin',
        r'^Role of Dietary Antioxidants in the Skin',
        r'^Skin Inflammation\.',
        r'^Compromised Skin Structural',
        r'^Skin Infection\.',
        r'^Pigmentary Skin Disorders',
        r'^Skin Aging\.',
        r'^Grapes and Grape Phytochemicals',
        r'^Antiaging, Anti-pigmentation',
        r'^Role of Grapes or Grape Constituents in Skin Diseases',
        r'^Effects of Grapes on Melanoma',
        r'^Effects of Resveratrol and Its Derivatives',
        r'^Effects of Piceatannol on Melanoma',
        r'^Effects of Grape Seed Proanthocyanidins on Melanoma',
        r'^Other Grape Phytochemicals on Melanoma',
        r'^Effects of Grapes on Non-melanoma',
        r'^Effects of Resveratrol on Non-melanoma',
        r'^Effects of Grape Seed Proanthocyanidins on Non',
        r'^Effects of Grapes on Atopic Dermatitis',
        r'^Effects of Grapes on Psoriasis',
        r'^Grape Extracts or Phytochemicals',
        r'^Uses of Grape',
        # Ch07 - UV Skin Damage
        r'^Ultraviolet Radiation\.',
        r'^Epidemiology of Skin Cancer',
        r'^Skin Cancer\.',
        r'^Grapes and Phytochemicals for Skin Health',
        r'^Cell Cycle Arrest and Apoptosis',
        r'^Anti-inflammatory Properties',
        r'^Antioxidant Properties',
        r'^Clinical Trial Insights',
        r'^Innate Immune Cells',
        r'^Studies on UV-Induced',
        r'^Preclinical Trials',
        r'^Grape Consumption and UV',
        r'^New Findings on',
        r'^R N A-Seq',
        # Ch08 - Transcriptomics
        r'^Diet and Health',
        r'^Grapes as a Dietary',
        r'^Targeted Actions Mediated',
        r'^Modulation of Targeted Gene Expression',
        r'^Nutrigenomics\.',
        r'^Nutrigenomics Effects of',
        r'^Transcriptomic Effects Mediated',
        r'^Effect of Grapes on Brain',
        r'^Effect of Grapes on Skeletal',
        r'^Effect of Grapes on Kidney',
        r'^Multiorgan Effects of Grapes',
        r'^Effects of Grapes on Gene Expression',
        r'^Nutrigenomic Effects in Humans',
        r'^Future Directions\.',
        # Ch09 - Metabolome
        r'^Effects of Grapes and Grape Extracts',
        r'^Extracts of Red Wine and Grape Juice',
        r'^Whole Grape Powder\.',
        r'^Effects of Grapes on the Human Plasma',
        r'^Red Grape Extract\.',
        # Ch10 - Overview
        r'^Background\.',
        r'^Synopses of Grapes and Health',
        r'^Antioxidant Status\.',
        r'^Bladder Health\.',
        r'^Breast Health\.',
        r'^Bone and Joint Health\.',
        r'^Bone Response',
        r'^Brain Health\.',
        r'^Eye Health\.',
        r'^Gastrointestinal Health\.',
        r'^Heart Health\.',
        r'^Inflammation\.',
        r'^Immune Health\.',
        r'^Kidney Health\.',
